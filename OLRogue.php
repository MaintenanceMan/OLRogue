...
<script type="text/javascript">
    ...
    // Whether user has logged in or created a new character.
    // If this is not set, then there was an error and we
    // should not start up the game.
    var gGameStarted = false;
    // The error message if the game does not start.
    var gFailMessage;
    <?php
        function setFailMessage($msg)
        {
            echo "gFailMessage = '$msg';";
        }
        // The version of the game the user started the character with.
        $version = 1;
        $bGameStarted = FALSE;
	    $DBConnect = @mysql_connect("localhost","jpendell_user","vabtha");
	    if ($DBConnect === FALSE)
	    {
		    setFailMessage("Unable to connect to the database server.");
	    }
	    else
	    {
		    ...
		    {
			    setFailMessage("Cannot find database.");
		    }
		    else
		    {
			    $TableName = "players";
			    ...
			    {
				    setFailMessage("You must enter a username and password.");
			    }
			    else
			    {
				    ...
				    {
					    // Creating a new user
					    // TO DO: Add the date when the user was created
					    $SQLstring = "INSERT INTO players(username,password,dlevel,experience,xptolevelup,clevel,maxplayerhp,currhp,created,updated,version)"
                                    . " VALUES ('$username','$password',1,0,10,1,10,10,now(),now(),$version)";
					    $QueryResult = @mysql_query($SQLstring,$DBConnect);
					    ...
					    {
						    setFailMessage("Problem creating user");
					    }
				    }
				    else
				    {
                    ...
                    if ($bGameStarted)
                    {
                        // Set flag so JavaScript knows to proceeed with game setup.
				        echo "gGameStarted = true;";
	...
	function drawShape()
	{
		switch(gDLevel)
		{
			case 1:		drawOutline();	break;
			case 2:		drawCheckers();	break;
			case 3:		drawGrid();	break;
			case 4:		drawMobius();		break;
			case 5:		drawEllipse();	break;
			case 6:		drawHexagon();	break;
			case 7:		drawBigX();	break;
			case 8:		drawCross();		break;
			case 9:		drawDiamond();	break;
			case 10:	drawTriangle();	break;
		}
	}
	...
	function initialize()
	{
        ...
        if (gGameStarted)
        {
            // Login or character creation was successful.
		    initMazeArray();
        ...
        else
        {
            ...
            // Clear out normal game start messages.
            message("");
            message("");
            // Show why we cannot start the game.
            message(gFailMessage);
        }
	}
	function heal()
	{
...
//			gMaxPlayerHP += 10;
	...
	{
		if (gWinner || gDead || !gGameStarted)
		{
            // User cannot do anything if login failed, character creation
            // failed, the game has been won, or the game has been lost.
			return true;
		}
		var keynum;
		var keychar;
...
<form style='display:inline; margin: 0; padding: 0' method='POST' action='Save.php'>
...
<input style='display:inline;' type='submit' id="save" value='Save' />
</form>
<div id="maze"></div>
<div id="msg1"></div>
<div id="msg2"></div>
